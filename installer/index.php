...
define('riOffiria_SQL_FILEPATH', realpath('./sql/riOffiria.sql'));
...
if ($_GET) {
	...
	// #2: install riOffiria database
	if ($canProceed && !$database->createDatabase($dbo, $db_name)) {
		$link = '';
		$link .= '<p>';
		$link .= 'This is a fresh install of riOffiria, <b>'. $db_name . '</b> database will be removed (this action is not reversible)<br />';
	...
	if ($canProceed && !$database->populateDatabase($dbo, riOffiria_SQL_FILEPATH)) {
		$canProceed = false;
		$errorMessage = 'Failed to install riOffiria';
		// exit('Failed to install riOffiria');
	}
...
<title>riOffiria Installation</title>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="span10 installer-container">
						...
						<div class="row">
							...
							<div class="span9">
								<div class="main-content">
									...
									<p>
										You have already installed riOffiria. If you want to reinstall, remove <?php echo CONFIG_FILEPATH; ?>
									</p>
									<?php elseif (!$isSuccessful && !$cannotProceed): // the initial page to load ?>
									<h2>Welcome.</h2>
									<p>
										Kindly fill the necessary information to proceed with riOffiria installation. <br />
									</p>
									...
									<div id="system-message-container">
										<div class="alert alert-success">
											The riOffiria installation is <b>complete</b>. It is highly recommended that you revert the permissions of <b><?php echo
											INSTALLATION_DIR; ?></b> to default (<?php echo $_SESSION['default_permission']; ?>) or (0755).
											<br />
											<br />
											<a href="../">Click here</a> to go to your new riOffiria site.
										</div>
									</div>
									<?php endif; ?>
								</div>
				...
				<div class="row">
					<div class="span10 riOffiria-section clearfix">
						<div class="row">
							<div class="span1">
								<div class="i-content riOffiria"></div>
							</div>
							<div class="span9">
								<div class="main-content">
									<h2>riOffiria Configuration.</h2>
							...
							<div class="span10">
								<div class="footer-content">
									<?php /*<div class="pull-left">
											By creating an account, you agree with our <a href="https://riOffiria.com/terms-of-service/" target="_blank">Terms of Service</a> and <a href="https://riOffiria.com/privacy-policy/" target="_blank">Privacy Policy</a>.
									</div> */ ?>
									<div class="pull-right">
										<input class="btn btn-info" type="submit" id="submit" value="Install riOffiria">
										</div>
										<div class="clear"></div>
									</div>
								</div>
